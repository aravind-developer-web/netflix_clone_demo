# netflix_clone_demo
A simple Netflix-style web application built using Django. This project includes user authentication, browsing movies, watching trailers, and a modern UI inspired by Netflix.
...
style="background-image: url('{{movie.image_card.url}}'); background-size: cover; background-
position: center;">
</div>
{% endfor %}
</div>
...
src="https://bloximages.newyork1.vip.townnews.com/newsrecord.org/content/tncms/assets/v3/editorial/8/1e/81e
a500c-45ac-11ee-a11e-a7402910a7e7/64ecaae69243a.image.jpg" alt="Movie Image" class=" mb-5">
...
<button id="addToListButton" onclick="addItemToList()" class="border border-white text-white p-2
px-5 rounded hover:bg-gray-700">
Add to List
</button>
</div>
</div>
...
<p>2024 by Priyanka | All Rights Reserved.</p>
...
<img src="https://upload.wikimedia.org/wikipedia/commons/7/7a/Logonetflix.png" height="30"
alt="Netflix Logo" width="110">
<nav class="flex space-x-5">
<span><a href="{% url 'app:index' %}"><i class="fa-solid fa-house"></i></i> Home</a></span>
<div class="dropdown">
<span id="dropdownMenuButton" class="cursor-pointer"><i class="fa-solid fa-user-gear"></i>
Genres ▼</span>
...
<div class="footer">
<div class="footer-text">
<p>CREATED BY (PRIYANKA:SWETAPADMA:MONALISA:CHETAN) (2024) | "All Rights
Reserved".</p>
</div>
<div class="footer-iconTop">
<a href="#"><i class="fa-solid fa-arrow-up"></i></i></a>
...
<style>
body{
background-image: url('{% static "img/netflix1.png" %}');
...
<button style="color:white" type="submit" class="signup-btn">Get Started ></button>
</form>
<div class="help-text" align="center">
<span>Ready to watch? Enter your email to create or restart your membership.</span>
<br>
<br>
<span>Already have an account? <a href="{% url 'app:login' %}">Login</a></span>
</div>
</div>
</div>
</body>
